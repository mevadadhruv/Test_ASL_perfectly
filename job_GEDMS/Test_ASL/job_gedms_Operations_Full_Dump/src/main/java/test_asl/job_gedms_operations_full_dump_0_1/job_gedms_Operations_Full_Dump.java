...
package test_asl.job_gedms_operations_full_dump_0_1;
...
/**
 * Job: job_gedms_Operations_Full_Dump Purpose: <br>
 * Description:  <br>
 * @author security@company.com
 * @version 8.0.1.20231017_1026-patch
 * @status 
 */
public class job_gedms_Operations_Full_Dump implements TalendJob {
	static {System.setProperty("TalendJob.log", "job_gedms_Operations_Full_Dump.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(job_gedms_Operations_Full_Dump.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_gedms_Operations_Full_Dump";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_bTrBwFbpEe6MusZcIWCVEA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_gedms_Operations_Full_Dump.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_gedms_Operations_Full_Dump.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
		...
		if(enableLogStash) {
			...
			public void tGSPut_3_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				status = "failure";
				
					tGSPut_3_onSubJobError(exception, errorComponent, globalMap);
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tGSPut_3_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "MQAcTv_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tRunJob_1{
                    ...
                    log4jParamters_tRunJob_1.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_1.append(" | ");
                            log4jParamters_tRunJob_1.append("PROCESS" + " = " + "job_gedms_Operations_Full_Dump_Job");
                        log4jParamters_tRunJob_1.append(" | ");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
	        					...
	        					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "test_asl.job_gedms_operations_full_dump_job_0_1.job_gedms_Operations_Full_Dump_Job");
...
globalMap.put("tRunJob_1_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_1 = consoleHelper_tRunJob_1.getNormalThread(ps_tRunJob_1);
                log.info("tRunJob_1 - The child job 'job_gedms_Operations_Full_Dump_Job' starts on the version '0.1' with the context 'Default'.");
            normal_tRunJob_1.start();
                log.info("tRunJob_1 - The child job 'job_gedms_Operations_Full_Dump_Job' is done.");
...
public void tGSConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "PHrVbV_" + subJobPidCounter.getAndIncrement());
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tGSConnection_1:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tGSPut_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "wc8Ptx_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tGSPut_1{
                    ...
                    log4jParamters_tGSPut_1.append("Parameters:");
                        ...
                        log4jParamters_tGSPut_1.append(" | ");
                            log4jParamters_tGSPut_1.append("LOCALDIR" + " = " + "\"D:/dnt/asl/talend/recordFiles/operation\"");
                        log4jParamters_tGSPut_1.append(" | ");
                            log4jParamters_tGSPut_1.append("REMOTEDIR" + " = " + "\"gedms_report_records/Operations\"");
                        log4jParamters_tGSPut_1.append(" | ");
 ...
 */
  ...
  com.google.cloud.storage.Storage storage_tGSPut_1 = (com.google.cloud.storage.Storage)globalMap.get("service_tGSConnection_1");
	...
	java.io.File file_tGSPut_1 = new java.io.File("D:/dnt/asl/talend/recordFiles/operation");
	org.talend.gs.util.GSObjectUtil gsObjectUtil_tGSPut_1 = new org.talend.gs.util.GSObjectUtil();

	
		java.util.Map<String, java.io.File> fileMap_tGSPut_1 = gsObjectUtil_tGSPut_1.generateFileMap(file_tGSPut_1, "gedms_report_records/Operations");
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tGSPut_1:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tGSPut_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tGSPut_3_SUBPROCESS_STATE", 0);

 final boolean execStat = this.execStat;
	
		mdcInfo.forEach(org.slf4j.MDC::put);
		org.slf4j.MDC.put("_subJobName", "tGSPut_3");
		org.slf4j.MDC.put("_subJobPid", "ePDqOD_" + subJobPidCounter.getAndIncrement());
	 ...
	 */
		...
		ok_Hash.put("tGSPut_3", false);
		start_Hash.put("tGSPut_3", System.currentTimeMillis());
		
	
	currentComponent="tGSPut_3";
	
	
		int tos_count_tGSPut_3 = 0;
		
                if(log.isDebugEnabled())
            log.debug("tGSPut_3 - "  + ("Start to work.") );
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tGSPut_3{
                    public void limitLog4jByte() throws Exception{
                    StringBuilder log4jParamters_tGSPut_3 = new StringBuilder();
                    log4jParamters_tGSPut_3.append("Parameters:");
                            log4jParamters_tGSPut_3.append("USE_EXISTING_CONNECTION" + " = " + "true");
                        log4jParamters_tGSPut_3.append(" | ");
                            log4jParamters_tGSPut_3.append("CONNECTION" + " = " + "tGSConnection_1");
                        log4jParamters_tGSPut_3.append(" | ");
                            log4jParamters_tGSPut_3.append("BUCKET" + " = " + "\"datalake-dremio\"");
                        log4jParamters_tGSPut_3.append(" | ");
                            log4jParamters_tGSPut_3.append("LOCALDIR" + " = " + "\"D:/dnt/asl/talend/recordDate/operation\"");
                        log4jParamters_tGSPut_3.append(" | ");
                            log4jParamters_tGSPut_3.append("REMOTEDIR" + " = " + "\"gedms_report_date/Operations\"");
                        log4jParamters_tGSPut_3.append(" | ");
                            log4jParamters_tGSPut_3.append("USE_FILES_LIST" + " = " + "false");
                        log4jParamters_tGSPut_3.append(" | ");
                            log4jParamters_tGSPut_3.append("DIE_ON_ERROR" + " = " + "false");
                        log4jParamters_tGSPut_3.append(" | ");
                            log4jParamters_tGSPut_3.append("PART_SIZE" + " = " + "50");
                        log4jParamters_tGSPut_3.append(" | ");
                if(log.isDebugEnabled())
            log.debug("tGSPut_3 - "  + (log4jParamters_tGSPut_3) );
                    } 
                } 
            new BytesLimit65535_tGSPut_3().limitLog4jByte();
            }
			if(enableLogStash) {
				talendJobLog.addCM("tGSPut_3", "tGSPut_1", "tGSPut");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	int nb_line_tGSPut_3 = 0;
	long partSizeInBytes_tGSPut_3 = (long)50 * 1024 * 1024;
	
	if(partSizeInBytes_tGSPut_3 > Integer.MAX_VALUE - 8) {
		partSizeInBytes_tGSPut_3 = Integer.MAX_VALUE - 8;
	}
	
  com.google.cloud.storage.Storage storage_tGSPut_3 = (com.google.cloud.storage.Storage)globalMap.get("service_tGSConnection_1");

	java.io.File file_tGSPut_3 = new java.io.File("D:/dnt/asl/talend/recordDate/operation");
	org.talend.gs.util.GSObjectUtil gsObjectUtil_tGSPut_3 = new org.talend.gs.util.GSObjectUtil();

	
		java.util.Map<String, java.io.File> fileMap_tGSPut_3 = gsObjectUtil_tGSPut_3.generateFileMap(file_tGSPut_3, "gedms_report_date/Operations");
	
	for (java.util.Map.Entry<String, java.io.File> currentFile_tGSPut_3 : fileMap_tGSPut_3.entrySet()){
		com.google.cloud.storage.BlobInfo blobInfo_tGSPut_3 = com.google.cloud.storage.BlobInfo.
				newBuilder("datalake-dremio", currentFile_tGSPut_3.getKey()).build();
		if (partSizeInBytes_tGSPut_3 > 0 && java.nio.file.Files.size(currentFile_tGSPut_3.getValue().toPath()) > partSizeInBytes_tGSPut_3) {
			byte[] buffer = new byte[(int)partSizeInBytes_tGSPut_3];
			try (com.google.cloud.WriteChannel writer_tGSPut_3 = storage_tGSPut_3.writer(blobInfo_tGSPut_3); java.io.InputStream inputStreamForUpload_tGSPut_3 = java.nio.file.Files.newInputStream(currentFile_tGSPut_3.getValue().toPath())) {
				int curFileLimit_tGSPut_3;
				while ((curFileLimit_tGSPut_3 = inputStreamForUpload_tGSPut_3.read(buffer)) >= 0) {
					writer_tGSPut_3.write(java.nio.ByteBuffer.wrap(buffer, 0, curFileLimit_tGSPut_3));
				}
			} catch (IOException e_tGSPut_3) {
globalMap.put("tGSPut_3_ERROR_MESSAGE",e_tGSPut_3.getMessage());
				
					log.error("tGSPut_3 - Exception in component tGSPut_3:" + e_tGSPut_3.getMessage());
				
			}
		} else {
			try {
				storage_tGSPut_3.create(blobInfo_tGSPut_3, java.nio.file.Files.readAllBytes(currentFile_tGSPut_3.getValue().toPath()));
				nb_line_tGSPut_3 ++;
			} catch (IOException e_tGSPut_3) {
globalMap.put("tGSPut_3_ERROR_MESSAGE",e_tGSPut_3.getMessage());
	...
	globalMap.put("tGSPut_3_NB_LINE", nb_line_tGSPut_3);
 ...
 */
	...
	/**
	 * [tGSPut_3 process_data_begin ] start
	 */
...
/**
 * [tGSPut_3 process_data_begin ] stop
 */
	
	/**
	 * [tGSPut_3 process_data_end ] start
	 */
...
/**
 * [tGSPut_3 process_data_end ] stop
 */
	...
	currentComponent="tGSPut_3";
                ...
                if(log.isDebugEnabled())
            log.debug("tGSPut_3 - "  + ("Done.") );

ok_Hash.put("tGSPut_3", true);
end_Hash.put("tGSPut_3", System.currentTimeMillis());
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tGSPut_3:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
		...
		globalMap.put("tGSPut_3_SUBPROCESS_STATE", 1);
	}
...
public void tGSClose_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "eGbICZ_" + subJobPidCounter.getAndIncrement());
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "n1CChv_" + subJobPidCounter.getAndIncrement());
 ...
 */
    ...
    public static void main(String[] args){
        final job_gedms_Operations_Full_Dump job_gedms_Operations_Full_DumpClass = new job_gedms_Operations_Full_Dump();

        int exitCode = job_gedms_Operations_Full_DumpClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'job_gedms_Operations_Full_Dump' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'job_gedms_Operations_Full_Dump' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_bTrBwFbpEe6MusZcIWCVEA");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-12-20T08:52:01.847924700Z");
        ...
        try {
            ...
            java.io.InputStream inContext = job_gedms_Operations_Full_Dump.class.getClassLoader().getResourceAsStream("test_asl/job_gedms_operations_full_dump_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_gedms_Operations_Full_Dump.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'job_gedms_Operations_Full_Dump' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_gedms_Operations_Full_Dump");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'job_gedms_Operations_Full_Dump' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     94556 characters generated by Talend Data Integration 
