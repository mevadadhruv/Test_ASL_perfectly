...
package test_asl.job_gedms_projects_full_dump_job1_0_1;
...
/**
 * Job: job_gedms_Projects_Full_Dump_Job1 Purpose: Document_Full_Dump_Job<br>
 * Description:  <br>
 * @author security@company.com
 * @version 8.0.1.20231017_1026-patch
 * @status 
 */
public class job_gedms_Projects_Full_Dump_Job1 implements TalendJob {
	static {System.setProperty("TalendJob.log", "job_gedms_Projects_Full_Dump_Job1.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(job_gedms_Projects_Full_Dump_Job1.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_gedms_Projects_Full_Dump_Job1";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Tgrq8GM8Ee6mq7q8Z-rKPw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_gedms_Projects_Full_Dump_Job1.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_gedms_Projects_Full_Dump_Job1.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tPrejob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "QYq7s6_" + subJobPidCounter.getAndIncrement());
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "rBizKW_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:G6EvlNppBQL+FyT3HTvdjXIUtQvUJE7/Pf86uMTciAlHYO0GHzFvmOo0V90=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:A51eQ7BIzPC2iMARaS+mBCdjy0hhG/WOzbqTHF2XLFn5ovR9ctmeekLn+5A=");
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_TEST_ASL_job_gedms_Projects_Full_Dump_Job1 = new byte[0];
    static byte[] commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1.length) {
				if(length < 1024 && commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1.length == 0) {
   					commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1 = new byte[1024];
				} else {
   					commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1, 0, length);
			strReturn = new String(commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1, 0, length);
			strReturn = new String(commonByteArray_TEST_ASL_job_gedms_Projects_Full_Dump_Job1, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_ASL_job_gedms_Projects_Full_Dump_Job1) {
...
public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "6uhxRi_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"D:/dnt/asl/talend/recordFiles/project/projectData.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/dnt/asl/talend/recordFiles/project/projectData.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	///////////////////////
		...
		java.io.PrintStream consoleOut_tLogRow_1 = null;
				...
				sbHeader_tLogRow_1.append("name");
				
    			sbHeader_tLogRow_1.append("\t");
				
				sbHeader_tLogRow_1.append("description");
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"Projects\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    `Projects`.`id`,    `Projects`.`name`,    `Projects`.`description`,    `Projects`.`status`,    `Projects`.`createdAt`,    `Projects`.`updatedAt`,    `Projects`.`deletedAt` FROM `Projects`\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("ENABLE_STREAM" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("description")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("status")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("createdAt")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("updatedAt")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("deletedAt")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_1", "\"Projects\"", "tMysqlInput");
				talendJobLogProcess(globalMap);
			}
...
+"eatedAt`, \n  `Projects`.`updatedAt`, \n  `Projects`.`deletedAt`\nFROM `Projects`";
            ...
            row2.status = rs_tDBInput_1.getObject(4);
            if(rs_tDBInput_1.wasNull()){
                    row2.status = null;
            }
		                    }
				...
				if(rs_tDBInput_1.getString(5) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row2.createdAt = rs_tDBInput_1.getTimestamp(5);
					} else {
				...
				if(rs_tDBInput_1.getString(6) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row2.updatedAt = rs_tDBInput_1.getTimestamp(6);
					} else {
				...
				if(rs_tDBInput_1.getString(7) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row2.deletedAt = rs_tDBInput_1.getTimestamp(7);
					} else {
						row2.deletedAt = (java.util.Date) year0_tDBInput_1.clone();
					}
				} else {
					row2.deletedAt =  null;
				}
 ...
 */
	...
	currentComponent="tLogRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_1","\"Projects\"","tMysqlInput","tLogRow_1","tLogRow_1","tLogRow"
...
///////////////////////    			
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_1","\"Projects\"","tMysqlInput","tLogRow_1","tLogRow_1","tLogRow","output")) {
						talendJobLogProcess(globalMap);
					}
                ...
                class BytesLimit65535_tFileOutputDelimited_2{
                    ...
                    log4jParamters_tFileOutputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
                            log4jParamters_tFileOutputDelimited_2.append("FILENAME" + " = " + "\"D:/dnt/asl/talend/recordDate/project/projectMaxDate.csv\"");
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("D:/dnt/asl/talend/recordDate/project/projectMaxDate.csv")).getAbsolutePath().replace("\\","/");
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "MfArmx_" + subJobPidCounter.getAndIncrement());
 ...
 */
    ...
    public static void main(String[] args){
        final job_gedms_Projects_Full_Dump_Job1 job_gedms_Projects_Full_Dump_Job1Class = new job_gedms_Projects_Full_Dump_Job1();

        int exitCode = job_gedms_Projects_Full_Dump_Job1Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'job_gedms_Projects_Full_Dump_Job1' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'job_gedms_Projects_Full_Dump_Job1' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_Tgrq8GM8Ee6mq7q8Z-rKPw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-12-20T08:52:43.251676800Z");
        ...
        try {
            ...
            java.io.InputStream inContext = job_gedms_Projects_Full_Dump_Job1.class.getClassLoader().getResourceAsStream("test_asl/job_gedms_projects_full_dump_job1_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_gedms_Projects_Full_Dump_Job1.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'job_gedms_Projects_Full_Dump_Job1' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_gedms_Projects_Full_Dump_Job1");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'job_gedms_Projects_Full_Dump_Job1' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     227330 characters generated by Talend Data Integration 
 *     on the December 20, 2023, 2:22:43 PM IST
 ************************************************************************************************/