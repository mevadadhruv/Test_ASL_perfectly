...
package test_asl.job_gedms_projects_full_dump_0_1;
...
/**
 * Job: job_gedms_Projects_Full_Dump Purpose: <br>
 * Description:  <br>
 * @author security@company.com
 * @version 8.0.1.20231017_1026-patch
 * @status 
 */
public class job_gedms_Projects_Full_Dump implements TalendJob {
	static {System.setProperty("TalendJob.log", "job_gedms_Projects_Full_Dump.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(job_gedms_Projects_Full_Dump.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_gedms_Projects_Full_Dump";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_3v9rIGM9Ee6mq7q8Z-rKPw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_gedms_Projects_Full_Dump.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_gedms_Projects_Full_Dump.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "vcEsDy_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tRunJob_1{
                    ...
                    log4jParamters_tRunJob_1.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_1.append(" | ");
                            log4jParamters_tRunJob_1.append("PROCESS" + " = " + "job_gedms_Projects_Full_Dump_Job1");
                        log4jParamters_tRunJob_1.append(" | ");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
	        					...
	        					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "test_asl.job_gedms_projects_full_dump_job1_0_1.job_gedms_Projects_Full_Dump_Job1");
...
globalMap.put("tRunJob_1_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_1 = consoleHelper_tRunJob_1.getNormalThread(ps_tRunJob_1);
                log.info("tRunJob_1 - The child job 'job_gedms_Projects_Full_Dump_Job1' starts on the version '0.1' with the context 'Default'.");
            normal_tRunJob_1.start();
                log.info("tRunJob_1 - The child job 'job_gedms_Projects_Full_Dump_Job1' is done.");
...
public void tGSConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "fJAl7L_" + subJobPidCounter.getAndIncrement());
...
public void tGSPut_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "ucQ5kE_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tGSPut_1{
                    ...
                    log4jParamters_tGSPut_1.append("Parameters:");
                        ...
                        log4jParamters_tGSPut_1.append(" | ");
                            log4jParamters_tGSPut_1.append("LOCALDIR" + " = " + "\"D:/dnt/asl/talend/recordDate/project\"");
                        log4jParamters_tGSPut_1.append(" | ");
                            log4jParamters_tGSPut_1.append("REMOTEDIR" + " = " + "\"gedms_report_date/Projects\"");
                        log4jParamters_tGSPut_1.append(" | ");
 ...
 */
  ...
  com.google.cloud.storage.Storage storage_tGSPut_1 = (com.google.cloud.storage.Storage)globalMap.get("service_tGSConnection_1");
	...
	java.io.File file_tGSPut_1 = new java.io.File("D:/dnt/asl/talend/recordDate/project");
	org.talend.gs.util.GSObjectUtil gsObjectUtil_tGSPut_1 = new org.talend.gs.util.GSObjectUtil();

	
		java.util.Map<String, java.io.File> fileMap_tGSPut_1 = gsObjectUtil_tGSPut_1.generateFileMap(file_tGSPut_1, "gedms_report_date/Projects");
...
public void tGSPut_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "Rz2BPt_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tGSPut_2{
                    ...
                    log4jParamters_tGSPut_2.append("Parameters:");
                        ...
                        log4jParamters_tGSPut_2.append(" | ");
                            log4jParamters_tGSPut_2.append("LOCALDIR" + " = " + "\"D:/dnt/asl/talend/recordFiles/project\"");
                        log4jParamters_tGSPut_2.append(" | ");
                            log4jParamters_tGSPut_2.append("REMOTEDIR" + " = " + "\"gedms_report_records/Projects\"");
                        log4jParamters_tGSPut_2.append(" | ");
 ...
 */
  ...
  com.google.cloud.storage.Storage storage_tGSPut_2 = (com.google.cloud.storage.Storage)globalMap.get("service_tGSConnection_1");
	...
	java.io.File file_tGSPut_2 = new java.io.File("D:/dnt/asl/talend/recordFiles/project");
	org.talend.gs.util.GSObjectUtil gsObjectUtil_tGSPut_2 = new org.talend.gs.util.GSObjectUtil();

	
		java.util.Map<String, java.io.File> fileMap_tGSPut_2 = gsObjectUtil_tGSPut_2.generateFileMap(file_tGSPut_2, "gedms_report_records/Projects");
...
public void tGSClose_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "WnuzJG_" + subJobPidCounter.getAndIncrement());
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "nTyMhW_" + subJobPidCounter.getAndIncrement());
 ...
 */
    ...
    public static void main(String[] args){
        final job_gedms_Projects_Full_Dump job_gedms_Projects_Full_DumpClass = new job_gedms_Projects_Full_Dump();

        int exitCode = job_gedms_Projects_Full_DumpClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'job_gedms_Projects_Full_Dump' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'job_gedms_Projects_Full_Dump' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_3v9rIGM9Ee6mq7q8Z-rKPw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-12-20T08:52:43.485678300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = job_gedms_Projects_Full_Dump.class.getClassLoader().getResourceAsStream("test_asl/job_gedms_projects_full_dump_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_gedms_Projects_Full_Dump.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'job_gedms_Projects_Full_Dump' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_gedms_Projects_Full_Dump");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'job_gedms_Projects_Full_Dump' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     93620 characters generated by Talend Data Integration 
