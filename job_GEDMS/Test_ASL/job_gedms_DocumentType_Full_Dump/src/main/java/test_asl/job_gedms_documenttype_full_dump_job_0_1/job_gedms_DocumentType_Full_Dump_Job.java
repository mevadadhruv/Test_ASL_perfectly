...
package test_asl.job_gedms_documenttype_full_dump_job_0_1;
...
/**
 * Job: job_gedms_DocumentType_Full_Dump_Job Purpose: Document_Full_Dump_Job<br>
 * Description:  <br>
 * @author security@company.com
 * @version 8.0.1.20231017_1026-patch
 * @status 
 */
public class job_gedms_DocumentType_Full_Dump_Job implements TalendJob {
	static {System.setProperty("TalendJob.log", "job_gedms_DocumentType_Full_Dump_Job.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(job_gedms_DocumentType_Full_Dump_Job.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "job_gedms_DocumentType_Full_Dump_Job";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_8Dow4F6JEe63sJ3K9Ad75w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_gedms_DocumentType_Full_Dump_Job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_gedms_DocumentType_Full_Dump_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tPrejob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "ffi7fI_" + subJobPidCounter.getAndIncrement());
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "wRzCnv_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:o1bkmGbAsEqCgfVLlOUePjZXoTYg+fUIKAou6mLcYrEpzTh/cEtpwoXMj7k=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:yDB8K/3GN1WN1G7QNtlQPKDznhqZ61blgAGvQdxevDZWhyOrzsJIlm2WjsY=");
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job = new byte[0];
    static byte[] commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job.length) {
				if(length < 1024 && commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job.length == 0) {
   					commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job = new byte[1024];
				} else {
   					commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job, 0, length);
			strReturn = new String(commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job, 0, length);
			strReturn = new String(commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    ...
    static byte[] commonByteArray_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job = new byte[0];
				...
				public Boolean documentTypeIsNullable(){
				    return false;
				}
				public Boolean documentTypeIsKey(){
				    return false;
				}
				public Integer documentTypeLength(){
				    return 45;
				}
				public Integer documentTypePrecision(){
				    return 0;
				}
				public String documentTypeDefault(){
				
					return null;
				
				}
				public String documentTypeComment(){
				
				    return "";
				
				}
				public String documentTypePattern(){
				
					return "";
				
				}
				public String documentTypeOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_TEST_ASL_job_gedms_DocumentType_Full_Dump_Job) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.documentType = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.documentType,dos);
...
public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "7N5yB9_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"D:/dnt/asl/talend/recordFiles/documentType/documentTypeData.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/dnt/asl/talend/recordFiles/documentType/documentTypeData.csv")).getAbsolutePath().replace("\\","/");
                ...
                resourceMap.put("out_tFileOutputDelimited_1", outtFileOutputDelimited_1);
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("projectId");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("documentType");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	///////////////////////
		...
		java.io.PrintStream consoleOut_tLogRow_1 = null;
				...
				sbHeader_tLogRow_1.append("projectId");
				
    			sbHeader_tLogRow_1.append("\t");
				
				sbHeader_tLogRow_1.append("documentType");
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TABLE" + " = " + "\"DocumentTypes\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT * FROM `DocumentTypes`\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("ENABLE_STREAM" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("projectId")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("documentType")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("status")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("createdAt")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("updatedAt")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("deletedAt")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_2", "\"DocumentTypes\"", "tMysqlInput");
				talendJobLogProcess(globalMap);
			}
		    ...
		    String dbquery_tDBInput_2 = "SELECT * FROM `DocumentTypes`";
            ...
            row2.projectId = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row2.documentType = null;
							} else {
	                         		
        	row2.documentType = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row2.status = null;
							} else {
		                          
            row2.status = rs_tDBInput_2.getObject(4);
            if(rs_tDBInput_2.wasNull()){
                    row2.status = null;
            }
		                    }
				...
				if(rs_tDBInput_2.getString(5) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row2.createdAt = rs_tDBInput_2.getTimestamp(5);
					} else {
						row2.createdAt = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row2.createdAt =  null;
				}
				...
				if(rs_tDBInput_2.getString(6) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row2.updatedAt = rs_tDBInput_2.getTimestamp(6);
					} else {
						row2.updatedAt = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row2.updatedAt =  null;
				}
				...
				if(rs_tDBInput_2.getString(7) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row2.deletedAt = rs_tDBInput_2.getTimestamp(7);
					} else {
						row2.deletedAt = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row2.deletedAt =  null;
				}
 ...
 */
	...
	currentComponent="tLogRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","\"DocumentTypes\"","tMysqlInput","tLogRow_1","tLogRow_1","tLogRow"
...
///////////////////////		
	    		...
	    		if(row2.documentType != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row2.documentType)							
				);
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tLogRow_1","tLogRow_1","tLogRow","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row3.createdAt != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row3.createdAt, "yyyyMMddHHmmss")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row3.updatedAt != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row3.updatedAt, "yyyyMMddHHmmss")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row3.deletedAt != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row3.deletedAt, "yyyyMMddHHmmss")
                        );
                            }
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGOUT";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited","tAggregateRow_1_AGGOUT","tAggregateRow_1_AGGOUT","tAggregateOut"
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_1.put(operation_result_tAggregateRow_1, operation_result_tAggregateRow_1);
				...
				if(row1.createdAt != null) { // G_OutMain_AggR_546
				
					if( 
						
							operation_result_tAggregateRow_1.createdAt_max == null || row1.createdAt.compareTo(operation_result_tAggregateRow_1.createdAt_max) > 0
						
					) {
						operation_result_tAggregateRow_1.createdAt_max = row1.createdAt;
					}
					
				} // G_OutMain_AggR_546
				
				if(row1.updatedAt != null) { // G_OutMain_AggR_546
				
					if( 
						
							operation_result_tAggregateRow_1.updatedAt_max == null || row1.updatedAt.compareTo(operation_result_tAggregateRow_1.updatedAt_max) > 0
						
					) {
						operation_result_tAggregateRow_1.updatedAt_max = row1.updatedAt;
					}
...
///////////////////////    			
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","\"DocumentTypes\"","tMysqlInput","tLogRow_1","tLogRow_1","tLogRow","output")) {
						talendJobLogProcess(globalMap);
					}
                ...
                class BytesLimit65535_tFileOutputDelimited_3{
                    ...
                    log4jParamters_tFileOutputDelimited_3.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_3.append(" | ");
                            log4jParamters_tFileOutputDelimited_3.append("FILENAME" + " = " + "\"D:/dnt/asl/talend/recordDate/documentType/documentTypeMaxDate.csv\" ");
                        log4jParamters_tFileOutputDelimited_3.append(" | ");
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File("D:/dnt/asl/talend/recordDate/documentType/documentTypeMaxDate.csv" )).getAbsolutePath().replace("\\","/");
            ...
            final String OUT_DELIM_ROWSEP_tFileOutputDelimited_3 = /** Start field tFileOutputDelimited_3:ROWSEPARATOR */"\n"/** End field tFileOutputDelimited_3:ROWSEPARATOR */;
                ...
                resourceMap.put("out_tFileOutputDelimited_3", outtFileOutputDelimited_3);
                                    if(filetFileOutputDelimited_3.length()==0){
                                        outtFileOutputDelimited_3.write("maxDate");
 ...
 */
	...
	currentComponent="tLogRow_3";
		...
		int tos_count_tLogRow_3 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tLogRow_3", "tLogRow_2", "tLogRow");
				talendJobLogProcess(globalMap);
			}
...
if(out1 != null) { 
	...
	currentComponent="tLogRow_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"out1","tMap_1","tMap_1","tMap","tLogRow_3","tLogRow_2","tLogRow"
 ...
 */
	...
	currentComponent="tFileOutputDelimited_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row5","tLogRow_3","tLogRow_2","tLogRow","tFileOutputDelimited_3","tFileOutputDelimited_2","tFileOutputDelimited"
...
///////////////////////    			
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"out1",2,0,
			 			"tMap_1","tMap_1","tMap","tLogRow_3","tLogRow_2","tLogRow","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		resourceMap.put("finish_tFileOutputDelimited_3", true);
				...
				log.debug("tFileOutputDelimited_3 - Written records count: " + nb_line_tFileOutputDelimited_3 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row5",2,0,
			 			"tLogRow_3","tLogRow_2","tLogRow","tFileOutputDelimited_3","tFileOutputDelimited_2","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "L3xDeL_" + subJobPidCounter.getAndIncrement());
 ...
 */
    ...
    public static void main(String[] args){
        final job_gedms_DocumentType_Full_Dump_Job job_gedms_DocumentType_Full_Dump_JobClass = new job_gedms_DocumentType_Full_Dump_Job();

        int exitCode = job_gedms_DocumentType_Full_Dump_JobClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'job_gedms_DocumentType_Full_Dump_Job' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'job_gedms_DocumentType_Full_Dump_Job' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_8Dow4F6JEe63sJ3K9Ad75w");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-12-20T08:51:03.421828300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = job_gedms_DocumentType_Full_Dump_Job.class.getClassLoader().getResourceAsStream("test_asl/job_gedms_documenttype_full_dump_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_gedms_DocumentType_Full_Dump_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'job_gedms_DocumentType_Full_Dump_Job' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_gedms_DocumentType_Full_Dump_Job");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'job_gedms_DocumentType_Full_Dump_Job' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     227635 characters generated by Talend Data Integration 
 *     on the December 20, 2023, 2:21:03 PM IST
 ************************************************************************************************/